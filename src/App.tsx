        ...
        <footer className="bg-neutral-900 text-neutral-300 py-8 mt-auto">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-white font-medium mb-4">VP-Garments</h3>
                <p className="text-sm">
                  Your destination for premium fashion with a focus on quality and style.
                </p>
              </div>
              <div>
            ...
            <div className="mt-8 pt-6 border-t border-neutral-800 text-sm text-center">
              <p>© {new Date().getFullYear()} VP-Garments. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
